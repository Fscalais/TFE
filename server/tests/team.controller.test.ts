...
describe('Team Controller', () => {
  ...
  await teamCtrl.deleteTeam(req as any, res as any);
...
test('inviteMember -> 404 si utilisateur inconnu', async () => {
  ...
  (Team.findById as jest.Mock).mockResolvedValue({ _id: req.params.id, members: [], invitations: [], save: jest.fn() });
  await teamCtrl.inviteMember(req as any, res as any);
